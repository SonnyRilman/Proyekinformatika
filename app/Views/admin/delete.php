...
<body>
    ...
    <div class="container">
       <div class="container">
        <h2>Konfirmasi Hapus Data Ikan</h2>
        <?php helper(['form']); ?>
        <?php if ($ikanList): ?>
            <p>Pilih ikan yang ingin dihapus:</p>
    
            <!-- Formulir konfirmasi penghapusan -->
            <?= form_open('/admin/confirmDelete'); ?>
            ...
            <!-- Link untuk membatalkan -->
            <a href="/admin_home" role="button">Batal</a>
        <?php else: ?>
